...
//        }
        setData("1", 1 );
        setData("2", 1.2F );
        setData("3", "sdadsadsab" );
        setData("4", false );
        setData("5", 1211313132132132132L );
        setData("6", new HashSet<String>());
...
//            edit.putInt(key, (Integer) value);
            ...
            System.out.println("Boolean"+(Boolean) value);
//            edit.putBoolean(key, (Boolean) value);
        } else if (value instanceof Float) {
            System.out.println("Float"+(Float) value);
